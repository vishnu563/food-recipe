...
const MealSingle = ({ meal }) => {
  const { addToFavorites } = useMealContext(); // Access the addToFavorites function from context
  ...
  const handleAddToFavorites = () => {
    addToFavorites(meal); // Dispatch the action to add the meal to favorites
  };
        ...
        <section className='sc-details bg-white'>
          <div className='details-head grid'>
            ...
            <div className='details-intro'>
              ...
              <button className='fav-btn' onClick={handleAddToFavorites}>Add To Favorite <IoIosHeart size={30} /></button>
              <div className='py-4'>
